...
exports.sendNewTeam = function(users, team, coach_email, number) {
  //define html
  var result = '<!DOCTYPE html><html><head><style>'+css_new_team+'</style></head><body><h2>Team name: '+team.name+'</h2><h2>Team age: '+team.age+'</h2><h2>Number of trainee: '+number+'</h2><table class="blueTable"> <thead> <tr> <th>Username</th> <th>password</th> </tr> </thead>';
